...
const openApiSpec = {
  ...
  info: {
    ...
    description:
      "API for accessing Kyle Romero's professional resume in JSON Resume format",
    version: "1.0.0",
    contact: {
      name: "Kyle Romero",
  ...
  paths: {
    "/api/resume": {
      get: {
        summary: "Get Resume",
        description:
          "Retrieves Kyle Romero's complete professional resume in JSON Resume format",
        ...
        properties: {
          basics: {
            ...
            properties: {
              ...
              label: {
                type: "string",
                example: "Director of Software Development",
              },
              email: {
                type: "string",
                format: "email",
                example: "kgromero@gmail.com",
              },
              phone: { type: "string", example: "(281) 857-9006" },
              website: {
                type: "string",
                format: "uri",
                example: "https://kgromero.com",
              },
              summary: { type: "string" },
              location: {
                type: "object",
