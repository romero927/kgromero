...
<div class="min-h-screen bg-neo-cream dark:bg-gray-900 flex flex-col">
  ...
  <div class="flex-grow">
    ...
    <div class="mx-2 sm:mx-4 md:mx-8 lg:mx-16 xl:mx-24 2xl:mx-32 my-2 grid grid-cols-1 gap-3">
    ...
    <div class="mx-2 sm:mx-4 md:mx-8 lg:mx-16 xl:mx-24 2xl:mx-32 my-2 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3 mb-2">
